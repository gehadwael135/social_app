          ...
          appBar: AppBar(
            title: Text(
              context.read<SocialLayoutCubit>().title[context
                  ...
                  .currentIndex],style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.blue),
            ),
            actions: [
             Row(
              children: [
               IconButton(
                onPressed: (){}, icon: Icon(Icons.notifications,color: Colors.blue,size: 30,)),
          IconButton(
            onPressed: (){}, icon: Icon(Icons.search_rounded,color: Colors.blue,size: 30,))
